/**
* Cette classe est utilisee pour définir les evenements souris de GoBackButton
...
public class BackEvents implements MouseListener {
	...
	* @param goBackButton Bouton de retour
	...
	*/
	...
	public BackEvents(JFrame oldFrame, JFrame currentFrame, JButton goBackButton, int width, int height, int x, int y){	
		this.oldWindow = oldFrame;
		this.currentWindow = currentFrame;
		this.button = goBackButton;
	...
	public void mouseClicked(MouseEvent e) {
	    ...
	    if (buttonDown == MouseEvent.BUTTON1) { // Boutton GAUCHE enfoncé
	        this.currentWindow.dispose(); // Ferme la fenetre courrante
			this.oldWindow.setVisible(true); // Affiche l'ancienne fenetre
	...
	public void mouseEntered(MouseEvent e) {
		...
		button.setForeground(Color.BLACK); // Change la couleur de la police du bouton selectionne
	}
	...
	public void mouseExited(MouseEvent e) {
		...
		button.setForeground(Color.WHITE); // Retablit la couleur de la police par defaut du bouton 
	}
