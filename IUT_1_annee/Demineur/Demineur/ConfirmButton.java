/**
* Cette classe est utilisee pour creer le bouton de confirmation lors de la creation d'une grille par l'utilisateur
...
public class ConfirmButton extends JButton {
	...
	*/
	...
	public ConfirmButton (String titleButton, JFrame oldFrame, JFrame currentFrame, int width, int height, int putNumber, int position) { // putNumber = nombre de boutons, position = determine l'endroit ou se place le bouton par rapport aux autres
		super(titleButton);
		...
		this.addMouseListener(new ConfirmButtonEvents(oldFrame, currentFrame, this, width, height)); // Evenements du bouton
